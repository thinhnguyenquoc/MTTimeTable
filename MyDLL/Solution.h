...
public:
	...
	int ChooseChairForOneJury(int IDJury, int thresholdNumOfJury, int& chairID, int iCase);//Step 2a: Choose chair for one jury, iCase =0 or iCase = 3
	...
	bool ChooseNormalMembers();//choose normal member for juries
	int ChooseNormalMemberForOneJury(int IDJury, int thresholdNumofJury, int& normalID);
	...
	bool CheckIfPeriodIsOK(int JuryID, int iPeriod);
