...
public:
	...
	int CoefficienceCompareTwoSolutions(clsSolution* mySol1, clsSolution* mySol2, int coF1, int coF2, int coF3, int coF4);//compare 2 solution with 4 different coefficiences for 4 objective functions, return 0 if mySol1 is better than mySol2, and 1 if opposite
